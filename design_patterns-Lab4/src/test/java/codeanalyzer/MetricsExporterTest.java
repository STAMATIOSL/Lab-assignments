...
/**
* The MetricsExporterTest provides tests for the MetrcisExporter class.
*
...
public class MetricsExporterTest {
	...
	public void testWriteJson() {
		...
		doCallRealMethod().when(mockedExporter).parseFile("json", metrics, outputFilepath);
		mockedExporter.parseFile("json", metrics, outputFilepath);
		//just verify that the method was executed/called
		verify(mockedExporter).parseFile("json", metrics, outputFilepath);
	}
	
	@Test(expected = IllegalArgumentException.class)
	public void testWriteFileWithUknownFIleType() {
		mex.parseFile("non-existing-type", null, null);
	}
